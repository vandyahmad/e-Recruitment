...
<section>
    ...
    <div class="row justify-content-center mt-5 mb-5">
        <h2>Lowongan Yang Tersedia Untuk Anda</h2>
    </div>
    <!-- </div> -->
            ...
            <div class="col-md-6 col-lg-4 element-animate ">
                <div class="media block-6 d-block text-center">
                    ...
                    <div class="media-body">
                        ...
                        <p>BONET melayani lebih dari 200 Pelanggan yang terhubung melalui teknologi Dial Up, Nirkabel,
                            Kabel, dan Serat Optik sekarang </p>
                    </div>
                </div>
                ...
                <div class="col-md-5 pr-md-5 mb-5">
                    <div class="block-41">
                        ...
                        <div class="block-41-text">
                            <p>PT Bonet Utama yang juga di kenal sebagai BONET (Internet Bogor) didirikan di Bogor Oleh
                                Sudjaja Wira dan Michael Sunggjardi</p>
                            <p>Didukung oleh Indo Internet. Penyedia Layanan Internet pertama di Indonesia - BONET
                                memberikan layanannya kepada pelanggan pertama sejak 1 Juli 1995 dengan menggunakan
                                teknologi Dial Up. </p>
                            <p>BONET melayani lebih dari 2000 Pelanggan yang terhubung melalui teknologi Dial Up, Nirkabel,
                                Kabel, dan Serat Optik sekarang. Dan menyediakan Teknologi Broadband dan Kecepatan Tinggi
                                untuk memenuhi Kebutuhan Anda.</p>
                            <p><a href="/" class="readmore">Lihat Tentang Kami <span
