    ...
    <div class="card user-details-card">
        <div class="card-body">
            <div class="row justify-content-center mt-3 mb-3">
                <h2><strong>Your Detail Profile Data</strong></h2>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="upload_file">Update File</label>
                                            <div class="custom-file">
                                                ...
                                                <small>*Upload file berupa data scan (Cv,KTP,Ijazah,Sertifikat,SKCK,Surat Sehat,dll) jadikan satu file Format PDF.</small>
                                                @error('upload_file')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
