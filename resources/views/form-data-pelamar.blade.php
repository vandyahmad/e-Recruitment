                    ...
                    <div class="col-md-12">
                        ...
                        <form style="margin:50px;" action="{{ route('UsersData.store')}} " method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="info_lowongan" class="font-weight-bold">Sumber Info Lowongan</label>
                                        <select class="form-control @error('info_lowongan') is-invalid @enderror" id="info_lowongan" name="info_lowongan">
                                            <option value="">Pilih Sumber Info Lowongan</option>
                                            <option value="Referensi" {{ old('info_lowongan') == 'Referensi' ? 'selected' : '' }}>Referensi</option>
                                            <option value="Website" {{ old('info_lowongan') == 'Website' ? 'selected' : '' }}>Website</option>
                                            <option value="Linkedin" {{ old('info_lowongan') == 'LinkedIn' ? 'selected' : '' }}>Linkedin</option>
                                            <option value="JobStreet" {{ old('info_lowongan') == 'JobStreet' ? 'selected' : '' }}>JobStreet</option>
                                            <option value="Telegram" {{ old('info_lowongan') == 'Telegram' ? 'selected' : '' }}>Telegram</option>
                                            <option value="Instagram" {{ old('info_lowongan') == 'Instagram' ? 'selected' : '' }}>Instagram</option>
                                            <option value="Facebook" {{ old('info_lowongan') == 'Facebook' ? 'selected' : '' }}>Facebook</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pref_location" class="font-weight-bold">Preferensi Penempatan Kerja</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nilai" class="font-weight-bold">IPK/Nilai Akhir</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="upload_foto" class="font-weight-bold">Upload Foto Profile</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="upload_file" class="font-weight-bold">Upload CV</label>
                                        <div class="custom-file">
